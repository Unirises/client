...
Serializers _$serializers = (new Serializers().toBuilder()
      ..add(AdditionalListing.serializer)
      ..add(Additionals.serializer)
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<int>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(AdditionalListing)]),
          () => new ListBuilder<AdditionalListing>()))
    .build();
